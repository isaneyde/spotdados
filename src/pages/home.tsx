...
export const Home = () => {
    return (
        ...
        <body className="py-10 bg-[url(../img/bg-4.png)] bg-black text-black font-bold">
            <div>
                <h1 className="font-YuseiMagic text-[32px] m-20 text-2xl text-center text-white"> Olá, bem vindo(a)</h1>
