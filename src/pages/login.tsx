    ...
    <body className="py-20 bg-[(public/img/background.png)] bg-black">
      ...
      >
        ...
        <div className="remember=forget flex flex-row justify-around">
          ...
          <a href="#" className="text-white text-center font-light ">Forgot password?</a>
        </div>
        <NavLink
          className="p-3 rounded-3xl bg-amber-400 font:bold text-center align-items-w-75 m-10"
          to="/Sign"
          type="submit"
        >
          Entrar
